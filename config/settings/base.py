...
JAZZMIN_SETTINGS = {
    "site_title": "Sakeena Institute",
    "site_header": "Sakeena Institute Site Administration",
    "site_brand": "Sakeena Institute",
    "welcome_sign": "Welcome to Sakeena Institute Administration",
    "copyright": "Sakeena Institute",
    ...
    "icons": {
        ...
        "courses.Scholarship": "fas fa-graduation-cap",
        "consultations.Consultation": "fas fa-comments",
        "consultations.AvailableTimeslot": "fas fa-calendar-alt",
        "consultations.ConsultationPurchase": "fas fa-handshake",
        "books.Book": "fas fa-book",
        "orders.Order": "fas fa-shopping-cart",
        "orders.OrderItem": "fas fa-list-alt",
        "blogs.Blog": "fas fa-newspaper",
        "blogs.BlogCategory": "fas fa-tags",
        "memberships.MembershipPlan": "fas fa-id-card",
        "memberships.UserMembership": "fas fa-star",
        "donations.Donation": "fas fa-heart",
        ...
        "email_templates.EmailTemplate": "fas fa-envelope",
    },
...
BUNNY_BOOKS_CDN_HOSTNAME = env("BUNNY_BOOKS_CDN_HOSTNAME", default="")
